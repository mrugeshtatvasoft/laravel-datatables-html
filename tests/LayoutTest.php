...
use mrugeshtatvasoft\DataTables\Html\Layout;
use mrugeshtatvasoft\DataTables\Html\Tests\TestComponents\TestInlineView;
use mrugeshtatvasoft\DataTables\Html\Tests\TestComponents\TestLivewire;
use mrugeshtatvasoft\DataTables\Html\Tests\TestComponents\TestView;
...
class LayoutTest extends TestCase
{
    ...
    public function it_throws_an_exception_if_the_livewire_component_does_not_exist_when_adding_livewire_component(): void
    {
        ...
        $this->expectExceptionMessage('Unable to find component: [mrugeshtatvasoft\DataTables\Html\Tests\TestComponents\TestView]');
